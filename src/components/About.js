    ...
    <div className="container mx-auto flex px-10 py-10 md:flex-row flex-col items-center">
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <p className="mb-10 leading-relaxed text-justify font-serif">
          ...
          <br />
          While at Microverse I spent 1300+ hours mastering
          {' '}
          <span className="font-bold text-blue-900 text-opacity-100">
            algorithms,
          ...
          {' '}
          <span className="font-bold text-blue-900 text-opacity-100"> Ruby, Rails, JavaScript, React, and Redux.</span>
          <br />
          ...
          like
          {' '}
          <span className="font-bold text-blue-900 text-opacity-100">empathy, problem-solving, effective communication, multi-tasking, and more.</span>
        </p>
